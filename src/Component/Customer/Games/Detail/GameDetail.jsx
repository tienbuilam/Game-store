...
export default function CustomerGameDetail() {
    ...
    useEffect(() => {
        ...
        axios
            .post(`http://${domain}/game/detail`, formData)
            .then((res) => {
    ...
    const toggleWishlist = () => {
        ...
        if (isInWish) {
            ...
            axios
                ...
                .then((res) => {
                    if (res.data.OutDeleted === '1') setshowpopup3(true);
                    else {
            ...
            axios
                ...
                .then((res) => {
                    if (res.data.OutDeleted === '1') setshowpopup3(true);
                        ...
                        if (res.data.OutStatus === '0') setshowpopup1(true);
                        else {
                            if (res.data.OutRemain === '0') setshowpopup2(true);
                            setRender(!render);
                        }
                    }
                })
