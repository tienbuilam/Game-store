...
function AddGame() {
    ...
    const loadPicture = (e, number) => {
        ...
        if (e.target.files.length === 0) {
            ...
            if (number === 1) {
                setPic1(null);
                if (isRefValid(img1)) img1.current.src = defaultSrc;
            } else if (number === 2) {
                setPic2(null);
                if (isRefValid(img2)) img2.current.src = defaultSrc;
            } else if (number === 3) {
                setPic3(null);
                if (isRefValid(img3)) img3.current.src = defaultSrc;
            } else {
                setPic4(null);
                if (isRefValid(img4)) img4.current.src = defaultSrc;
            }
        } else {
    ...
    const createGame = (event) => {
        ...
        if (name === null) {
            ...
            axios
                .post(`http://${domain}/admin/game/create`, formData)
                .then((res) => {
    ...
    const stopChoosing = () => {
        for (let i = 0; i < checkbox.current.length; i++) checkbox.current[i].checked = false;
            ...
            <div className="flex-grow-1 w-100 overflow-auto d-flex flex-column mb-1">
                ...
                >
                    ...
                    <div className="d-flex align-items-center mb-3 mb-lg-0 text-center">
                        ...
                        &nbsp;&nbsp;
                        <button
                            className={`${styles.choose_categories} btn btn-primary btn-sm`}
                            onClick={() => {
                ...
                <div className={`d-flex align-items-center justify-content-center mt-auto mb-1`}>
                    ...
                    <button type="button" className={`btn btn-primary ms-3`} onClick={createGame}>
                        Confirm
                    </button>
                </div>
            </div>
